...
export async function dodajRezervaciju(formData: FormData) {
  ...
  try {
    ...
    redirect(createFailureRedirect('/rezervacije', message));
  }

  revalidatePath('/rezervacije');
  redirect(createSuccessRedirect('/rezervacije', 'successAdded'));
}
...
export async function dodajRezervacijuSaGostom(formData: FormData) {
  ...
  revalidatePath('/rezervacije');
  redirect(createSuccessRedirect('/rezervacije', 'successAddedWithGuest'));
}
...
export async function izmeniRezervacijuSaGostom(formData: FormData) {
  ...
  revalidatePath('/rezervacije');
  redirect(createSuccessRedirect('/rezervacije', 'successUpdatedWithGuest'));
}
