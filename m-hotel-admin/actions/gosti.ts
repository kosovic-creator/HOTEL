...
const requireValidId = (id: number | undefined, failurePath = '/gosti') => {
    if (!id) {
...
export async function dodajGosta(formData: FormData) {
    ...
    try {
        ...
        handleDbError(error, '/gosti', '/gosti/dodaj', "Greška pri dodavanju gosta:");
    }
...
export async function updateGost(formData: FormData) {
    ...
    try {
        ...
        handleDbError(error, '/gosti/izmeni', '/gosti/izmeni', "Greška pri izmeni gosta:");
    }
