        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-center">{t('number') || 'Broj sobe'}</TableHead>
              <TableHead className="text-center">{t('type') || 'Tip sobe'}</TableHead>
              <TableHead className="text-center">{t('capacity') || 'Kapacitet'}</TableHead>
              <TableHead className="text-center">{t('price') || 'Cena'}</TableHead>
              <TableHead className="text-center">{t('description') || 'Opis'}</TableHead>
              <TableHead className="text-center">{t('description_en') || 'Opis na engleskom'}</TableHead>
              <TableHead className="text-center">{t('type_en') || 'Tip na engleskom'}</TableHead>
              <TableHead className="text-center">{t('images') || 'Slike'}</TableHead>
