...
export default function GostForm({ gosti, errors, formData }: GostFormProps) {
  const { t } = useTranslation('gosti');
  ...
  return (
    <div className="border-b pb-6 mb-6">
      <h3 className="text-lg font-medium text-gray-900 mb-4">{t_any.guest_details}</h3>
      ...
      <div className="mb-4">
        <label className="inline-flex items-center">
          ...
          />
          <span className="ml-2 text-sm text-gray-600">{t_any.use_existing_guest}</span>
        </label>
      </div>
      ...
      {koristiPostojeceg && (
        <div className="mb-4">
          <SelectField
            name="postojeci_gost"
            label={t_any.select_existing_guest}
            placeholder={t_any.select_guest}
      ...
      <div className="space-y-4">
        <h4 className="text-md font-medium text-gray-700 mt-6 mb-4">
          {koristiPostojeceg ? t_any.guest_details : t_any.add_new_guest}
        </h4>

        <SelectField
          name="gost_titula"
          label={t_any.title}
          placeholder={t_any.select_title}
        ...
        <InputField
          name="gost_ime"
          label={t_any.first_name}
          placeholder={t_any.first_name_placeholder}
        ...
        <InputField
          name="gost_prezime"
          label={t_any.last_name}
          placeholder={t_any.last_name_placeholder}
        ...
        <InputField
          ...
          type="email"
          label={t_any.email}
          placeholder={t_any.email_placeholder}
        ...
        <SelectField
          name="gost_drzava"
          label={t_any.country}
          placeholder={t_any.select_country}
          value={gostPodaci.drzava}
          error={getError('gost_drzava')}
          readOnly={koristiPostojeceg}
          onChange={handleSelectChange('drzava')}
          options={[
            { value: "Montenegro", label: t_any.montenegro },
            { value: "Serbia", label: t_any.serbia },
            { value: "Bosnia and Herzegovina", label: t_any.bosnia },
            { value: "Croatia", label: t_any.croatia },
            { value: "Other", label: t_any.other }
          ]}
        />
        ...
        <InputField
          name="gost_telefon"
          label={t_any.phone}
          placeholder={t_any.phone_placeholder}
        ...
        <InputField
          name="gost_adresa"
          label={t_any.address}
          placeholder={t_any.address_placeholder}
        ...
        <InputField
          name="gost_grad"
          label={t_any.city}
          placeholder={t_any.city_placeholder}
        ...
        <div className="border-t pt-4 mt-6">
          <h5 className="text-sm font-medium text-gray-600 mb-3">{t_any.second_guest_optional}</h5>

          <SelectField
            name="gost_titula_drugog_gosta"
            label={t_any.second_guest_title}
            placeholder={t_any.select_title}
          ...
          <InputField
            ...
            label={t_any.second_guest_first_name}
            placeholder={t_any.first_name_placeholder}
          ...
          <InputField
            ...
            label={t_any.second_guest_last_name}
            placeholder={t_any.last_name_placeholder}
